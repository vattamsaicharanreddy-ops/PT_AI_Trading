...
def run_api():
    import uvicorn
    print(f"🌐 Starting API + Webhook on 0.0.0.0:{PORT}")
...
if __name__=="__main__":
    ...
    async def setup_webhook():
        try:
            ...
            me = await bot.get_me()
            print(f"✅ Bot verified: @{me.username} - WEBHOOK MODE ACTIVE - NO MORE CONFLICT!")
            await bot.close()
    ...
    print("✅ Webhook mode active - Bot will receive updates via /webhook endpoint - NO POLLING - NO CONFLICT")
    print("🌐 API running...")
    while True:
        time.sleep(60)
        print("💚 Webhook alive - No conflict possible")
